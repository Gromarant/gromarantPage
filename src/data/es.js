...
const spanish = {
  ...
  "fullPokeApp_desc": "Aplicación web desarrollada en React.js, SASS y Nextui.",
  "fullPokeApp_functionalities" : [ "Juego de memoria.", "Buscador.", "Sección para crear Pokémones."],
  "fullPokeApp_copyRight":["Mariangelica Rodriguez"],

  "gromaSnake_title": "Groma-Snake",
  "gromaSnake_links": [
    {
      "name": "Prototipo",
  ...
  "gromaSnake_desc": "Juego desarrollado en  HTML, CSS y JavaScript vanilla.",
  "gromaSnake_functionalities" : [ "Juego de la culebra.", "Reiniciar el juego.", "er Puntaje y score."],
  "gromaSnake_copyRight":["Mariangelica Rodriguez"],

  "funFace_title": "FunFace",
  "funFace_links": [
    {
      "name": "Prototipo",
  ...
  "funFace_desc": "Página web estática, desarrollada en HTML, CSS y JavaScript vanilla.",
  "funFace_functionalities" : [ "Mostrar un emoji aleatorio.", "Elegir emoji a mostrar desde selector."],
  "funFace_copyRight":["Mariangelica Rodriguez"],

  "robopage_title": "Robopage",
  "robopage_links": [
    {
      "name": "Repositorio",
  ...
  "robopage_desc": "Aplicación web en React.js",
  "robopage_functionalities" : [ "Buscador con solicitud de datos a una Api externa."],
  "robopage_copyRight":["Mariangelica Rodriguez"],
  ...
  "author_name": "Mariangelica Rodriguez",
  "author_profession": {
    "fullstack": "Desarrolladora Full stack",
    "ux/ui": "Diseñadora UI/UX"
  },
  "author_greating_src": {
    "small": "images/profile_greeting_card_es_small.svg",
    "large": "images/profile_greeting_card_es_large.svg"
  },
  "author_greating_alt": "Hola!! Encantada de que estés por aquí y que conozcas un poco sobre mí",
  "author_greating_title": "bienvenid@!!",
  ...
  "section_experience_title": "Experiencia",
  "section_Lang_title": "Lenguajes / herramientas",
  "section_academic_title": "Titulaciones",
  ...
  "scroll_btn_title": "subir",

  "location_title": "Dirección",
  "Location_place": "Madrid, España",

  "OnTheWeb_title": "En la web",
